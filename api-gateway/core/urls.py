...
from gateway.views import (
    AuthLoginView, UserRefreshTokenView,UserView,AuthProfileView,AuthRegisterView, UserLogoutTokenView,
...
router.register(r'auth/logout', UserLogoutTokenView, basename="user-logout")
